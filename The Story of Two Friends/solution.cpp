 ...
 *
 *  author  :   prodipdatta7
 *  created :   Wednesday 13-May, 2020  07:51:00 AM
**/
...
int main() {
    ...
    while (test--) {
    	...
    	int a, b, c ;
    	Int(n, a, b, c) ; 
    	ll lcm_ab = 1LL * a * b / __gcd(a, b) ; 
    	ll lcm_ac = 1LL * a * c / __gcd(a, c) ; 
    	ll lcm_bc = 1LL * c * b / __gcd(c, b) ; 
    	ll lcm_abc = lcm_ab * c / __gcd(lcm_ab, 1LL * c) ; 
    	int res = n / a + n / b - n / lcm_ab ; 
    	res -= (n / lcm_ac + n / lcm_bc - n / lcm_abc) ; 
    	printf("%d\n",res);
    }
